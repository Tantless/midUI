...
export const AiBooleanNode = memo(({ id, data, selected }: Props) => {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-sm font-semibold text-slate-700">布尔</span>
      </div>
      <input
        type="text"
...
AiBooleanNode.displayName = 'AiBooleanNode';
